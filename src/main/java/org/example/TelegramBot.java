...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "new-telegram-bank-bot";
    }

    @Override
    public String getBotToken() {
        return "7654333564:AAFPyJmsSeGqQInJPwRK6h37lHtfMoXF9io";
    }
    ...
    private void handleAwaitsExpense(Message incomingMessage, ChatState currentChat){
        ...
        changeState(IDLE_STATE, chatId, currentChat,"Трата успешно добавлена", List.of(ADD_EXPENSE_BTN, SHOW_CATEGORIES_BTN, SHOW_EXPENSES_BTN));
    }
